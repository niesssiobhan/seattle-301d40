...
// When joe.scope() is invoked, "this" is referring to the instance joe to the Class of Student. Returning the atrribute values in the constructor function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//When joe.scopeArrow() is invoked, "this" is forcing the arrow function on to the scope of joe so then the Window is being called.
// 3. Explain why "this" is different when an arrow function is used.
// When an arrow function is being used, "this" is different because an arrow function can't be used with a constructor function.
